...
// Unit tests for the dice-duel contract using a simple mock Ohloss.
...
fn setup_test() -> (
    ...
    // Deploy dice-duel with admin and Ohloss address
    let contract_id = env.register(DiceDuelContract, (&admin, &ohloss_addr));
