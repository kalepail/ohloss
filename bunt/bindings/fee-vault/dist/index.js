...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["",
            ...
            ""]), options);
    ...
    fromJSON = {
        ...
        get_rewards: (this.txFromJSON),
        set_rewards: (this.txFromJSON),
        get_b_tokens: (this.txFromJSON),
        admin_deposit: (this.txFromJSON),
        claim_rewards: (this.txFromJSON),
        admin_withdraw: (this.txFromJSON),
        claim_emissions: (this.txFromJSON),
        get_reward_data: (this.txFromJSON),
        get_reward_token: (this.txFromJSON),
        upgrade_contract: (this.txFromJSON),
        get_vault_summary: (this.txFromJSON),
        get_underlying_tokens: (this.txFromJSON),
        get_underlying_admin_balance: (this.txFromJSON)
    };
}
