...
/// Register and initialize the Ohloss contract
#[allow(clippy::too_many_arguments)]
pub fn create_ohloss_contract<'a>(
    env: &Env,
    admin: &Address,
    fee_vault: &Address,
    ...
    create_ohloss_contract_with_free_play(
        env,
        admin,
        fee_vault,
        soroswap_router,
...
/// Register and initialize the Ohloss contract with custom free play settings
#[allow(clippy::too_many_arguments)]
pub fn create_ohloss_contract_with_free_play<'a>(
    env: &Env,
    admin: &Address,
    fee_vault: &Address,
    soroswap_router: &Address,
    ...
    create_ohloss_contract_with_dev_share(
        env,
        admin,
        fee_vault,
        soroswap_router,
...
/// Register and initialize the Ohloss contract with custom dev reward share
#[allow(clippy::too_many_arguments)]
pub fn create_ohloss_contract_with_dev_share<'a>(
    env: &Env,
    admin: &Address,
    fee_vault: &Address,
    soroswap_router: &Address,
    ...
    OhlossClient::new(env, &contract_address)
}

/// Create a simple Ohloss contract with mock addresses for quick testing
///
...
pub fn create_test_ohloss<'a>(env: &Env, admin: &Address) -> OhlossClient<'a> {
...
/// Create Ohloss contract with real Soroswap for epoch cycling tests
///
...
pub fn create_ohloss_with_soroswap<'a>(env: &Env, admin: &Address) -> OhlossClient<'a> {
    ...
    let ohloss_client = create_ohloss_contract(
        env,
        admin,
        &fee_vault,
        &router.address,
    ...
    blnd_token_client.mint(&ohloss_client.address, &5000_0000000);
...
/// following the same pattern as assert_contract_error() for Ohloss errors.
///
/// # Example
/// ```
