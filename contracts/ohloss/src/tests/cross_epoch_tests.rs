...
fn test_cross_epoch_withdrawal_detection() {
    ...
    let (game_contract, _vault_addr, mock_vault, ohloss) = setup_cross_epoch_test(&env);
...
fn test_time_multiplier_persists_across_epochs() {
    ...
    let player_data_epoch1 = ohloss.get_player(&player1);
    assert_eq!(
    ...
    let player_data_epoch2 = ohloss.get_player(&player1);
    assert_eq!(
...
fn test_time_multiplier_reset_after_large_withdrawal() {
    ...
    let time_start_epoch0 = ohloss.get_player(&player1).time_multiplier_start;
    ...
    assert_eq!(
        ohloss.get_player(&player1).time_multiplier_start,
        time_start_epoch0
    );
    ...
    let time_start_after_reset = ohloss.get_player(&player1).time_multiplier_start;
